...
\begin{itemize}
    ...
    \includegraphics[width=0.95\textwidth]{images/einzeltransfer.png}
    \item \textbf{Blocktransfer}\\
    \includegraphics[width=0.95\textwidth]{images/blocktransfer.png}
    \item \textbf{Transfer auf Aufforderung}\\
    \includegraphics[width=0.95\textwidth]{images/aufforderungstransfer.png}
\end{itemize}
