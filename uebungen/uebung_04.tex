...
\begin{itemize}
    \item \textbf{Vollausschlagfehler:} Abweichende Steigung $\frac{\Delta U}{\Delta Z}$ $\Rightarrow$ Korrektur durch Multiplikation mit Faktor $c := \frac{\text{ideale Steigung}}{\text{gemessene Steigung}}$
    \item \textbf{Nullpunktfehler:} Kennlinie parallel zur Idealkurve, aber verschoben $\Rightarrow$ Korrektur durch Subtraktion eines Offsets $U_0$
    \item \textbf{Nichtlinearitätsfehler:} entstehen durch Bauteil-Toleranzen und Temperaturabhängigkeiten -- entziehen sich linearer Kompensation und erfordern aufwändigere Kalibrierverfahren
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{images/wandlungsfehler.png}
\end{figure}
